...
export enum LeaderEnum {
  ...
  RP_ROGER = 'OP13-003',
  RB_SABO = 'OP05-001',
  RB_SABO_OP13 = 'OP13-004',
  RED_SANJI = 'PRB01-001',
  GU_ROSINANTE = 'OP05-022',
  RP_SUGAR = 'OP10-003',
  ...
  GREEN_ODEN = 'OP01-031',
  UP_KAIDO = 'OP01-061',
  UP_CROCODILE = 'OP01-062',
  PURPLE_KING = 'OP01-091',
  GREEN_KINEMON = 'OP02-025',
  GU_SANJI = 'OP02-026',
  PURPLE_MAGELLAN = 'OP02-071',
  PB_ZEPHYR = 'OP02-072',
  GREEN_KURO = 'OP03-021',
  BY_LINLIN = 'OP03-077',
  GREEN_HODY = 'OP06-020',
  PB_KING = 'OP08-057',
  GREEN_JINBE = 'OP11-021',
  GY_SHIRAHOSHI = 'OP11-022',
  PURPLE_KATAKURI = 'OP11-062',
  GB_BROOK = 'OP15-022',
  BLUE_REBECCA = 'OP15-039',
  PURPLE_ENEL = 'OP15-058',
  YELLOW_LUFFY_OP15 = 'OP15-098',
  UP_HANNYABAL = 'EB01-021',
  BY_KYROS = 'EB01-040',
  GREEN_KID = 'ST02-001',
...
export const leaders: Leader[] = [
  createLeader('Crocodile', COLOR.BLUE, COLOR.BLUE, LeaderEnum.BLUE_CROCODILE, true),
  createLeader('Monkey D. Luffy', COLOR.RED, COLOR.RED, LeaderEnum.RED_LUFFY_ST21),
  createLeader('Eustass "Captain" Kid', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KID, true),
  createLeader('Kyros', COLOR.BLACK, COLOR.YELLOW, LeaderEnum.BY_KYROS),
  createLeader('Hannyabal', COLOR.BLUE, COLOR.PURPLE, LeaderEnum.UP_HANNYABAL),
  createLeader('Monkey D. Luffy', COLOR.YELLOW, COLOR.YELLOW, LeaderEnum.YELLOW_LUFFY_OP15),
  createLeader('Enel', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_ENEL),
  createLeader('Rebecca', COLOR.BLUE, COLOR.BLUE, LeaderEnum.BLUE_REBECCA),
  createLeader('Brook', COLOR.GREEN, COLOR.BLACK, LeaderEnum.GB_BROOK),
  createLeader('Charlotte Katakuri', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_KATAKURI),
  createLeader('Shirahoshi', COLOR.GREEN, COLOR.YELLOW, LeaderEnum.GY_SHIRAHOSHI),
  createLeader('Jinbe', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_JINBE),
  createLeader('King', COLOR.PURPLE, COLOR.BLACK, LeaderEnum.PB_KING),
  createLeader('Hody Jones', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_HODY),
  createLeader('Charlotte Linlin', COLOR.BLACK, COLOR.YELLOW, LeaderEnum.BY_LINLIN, true),
  createLeader('Kuro', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KURO, true),
  createLeader('Zephyr', COLOR.PURPLE, COLOR.BLACK, LeaderEnum.PB_ZEPHYR, true),
  createLeader('Magellan', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_MAGELLAN, true),
  createLeader('Sanji', COLOR.GREEN, COLOR.BLUE, LeaderEnum.GU_SANJI, true),
  createLeader('Kin\'emon', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KINEMON, true),
  createLeader('King', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_KING, true),
  createLeader('Crocodile', COLOR.BLUE, COLOR.PURPLE, LeaderEnum.UP_CROCODILE, true),
  createLeader('Kaido', COLOR.BLUE, COLOR.PURPLE, LeaderEnum.UP_KAIDO, true),
  createLeader('Kouzuki Oden', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_ODEN, true),
  createLeader('Trafalgar Law', COLOR.RED, COLOR.PURPLE, LeaderEnum.RP_LAW_P),
  createLeader('Lucy', COLOR.RED, COLOR.BLUE, LeaderEnum.RU_LUCY),
  createLeader('Krieg', COLOR.RED, COLOR.GREEN, LeaderEnum.RG_KRIEG),
  createLeader('Uta', COLOR.RED, COLOR.PURPLE, LeaderEnum.RP_UTA),
  createLeader('Monkey D. Garp', COLOR.RED, COLOR.BLACK, LeaderEnum.RB_GARP, true),
  createLeader('Monkey D. Dragon', COLOR.RED, COLOR.RED, LeaderEnum.RED_DRAGON),
  createLeader('Jewelry Bonney', COLOR.RED, COLOR.YELLOW, LeaderEnum.RY_BONNEY),
  createLeader('Trafalgar Law', COLOR.RED, COLOR.PURPLE, LeaderEnum.RP_LAW),
  createLeader('Trafalgar Law', COLOR.RED, COLOR.GREEN, LeaderEnum.RG_LAW, true),
  createLeader('Trafalgar Law', COLOR.GREEN, COLOR.YELLOW, LeaderEnum.GY_LAW),
  createLeader('Roronoa Zoro', COLOR.RED, COLOR.RED, LeaderEnum.RED_ZORO, true),
  createLeader('Portgas D. Ace', COLOR.RED, COLOR.RED, LeaderEnum.RED_ACE, true),
  createLeader('Portgas D. Ace', COLOR.BLUE, COLOR.YELLOW, LeaderEnum.BY_ACE),
  createLeader('Queen', COLOR.BLUE, COLOR.YELLOW, LeaderEnum.UY_QUEEN, true),
  createLeader('Charlotte Katakuri', COLOR.YELLOW, COLOR.YELLOW, LeaderEnum.YELLOW_KATAKURI, true),
  ...
  createLeader('Donquixote Doflamingo', COLOR.BLUE, COLOR.BLUE, LeaderEnum.BLUE_DOFFY, true),
  createLeader('Donquixote Doflamingo', COLOR.GREEN, COLOR.PURPLE, LeaderEnum.GP_DOFLAMINGO, true),
  createLeader('Smoker', COLOR.BLACK, COLOR.BLACK, LeaderEnum.BLACK_SMOKER, true),
  ...
  createLeader('Edward Newgate', COLOR.RED, COLOR.RED, LeaderEnum.RED_NEWGATE, true),
  createLeader('Iceburg', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_ICEBURG, true),
  ...
  createLeader('Arlong', COLOR.GREEN, COLOR.YELLOW, LeaderEnum.GY_ARLONG, true),
  createLeader('Issho', COLOR.GREEN, COLOR.BLACK, LeaderEnum.GB_ISSHO, true),
  createLeader('Kaido', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_KAIDO, true),
  createLeader('Uta', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_UTA),
  createLeader('Crocodile', COLOR.PURPLE, COLOR.YELLOW, LeaderEnum.PY_CROCODILE, true),
  ...
  createLeader('Monkey D. Luffy', COLOR.RED, COLOR.GREEN, LeaderEnum.RG_LUFFY, true),
  createLeader('Nefeltari Vivi', COLOR.RED, COLOR.BLUE, LeaderEnum.RU_VIVI_EB03),
  createLeader('Nefeltari Vivi', COLOR.RED, COLOR.BLUE, LeaderEnum.RU_VIVI, true),
