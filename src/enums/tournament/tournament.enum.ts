...
export const leaders: Leader[] = [
  createLeader('Crocodile', COLOR.BLUE, COLOR.BLUE, LeaderEnum.BLUE_CROCODILE),
  createLeader('Monkey D. Luffy', COLOR.RED, COLOR.RED, LeaderEnum.RED_LUFFY_ST21),
  createLeader('Eustass "Captain" Kid', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KID),
  ...
  createLeader('Charlotte Linlin', COLOR.BLACK, COLOR.YELLOW, LeaderEnum.BY_LINLIN),
  createLeader('Kuro', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KURO),
  createLeader('Zephyr', COLOR.PURPLE, COLOR.BLACK, LeaderEnum.PB_ZEPHYR),
  createLeader('Magellan', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_MAGELLAN),
  createLeader('Sanji', COLOR.GREEN, COLOR.BLUE, LeaderEnum.GU_SANJI),
  createLeader('Kin\'emon', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_KINEMON),
  createLeader('King', COLOR.PURPLE, COLOR.PURPLE, LeaderEnum.PURPLE_KING),
  createLeader('Crocodile', COLOR.BLUE, COLOR.PURPLE, LeaderEnum.UP_CROCODILE),
  createLeader('Kaido', COLOR.BLUE, COLOR.PURPLE, LeaderEnum.UP_KAIDO),
  createLeader('Kouzuki Oden', COLOR.GREEN, COLOR.GREEN, LeaderEnum.GREEN_ODEN),
  ...
  createLeader('Monkey D. Garp', COLOR.RED, COLOR.BLACK, LeaderEnum.RB_GARP),
  ...
  createLeader('Monkey D. Luffy', COLOR.RED, COLOR.GREEN, LeaderEnum.RG_LUFFY),
  createLeader('Nefeltari Vivi', COLOR.RED, COLOR.BLUE, LeaderEnum.RU_VIVI_EB03),
  createLeader('Nefeltari Vivi', COLOR.RED, COLOR.BLUE, LeaderEnum.RU_VIVI),
